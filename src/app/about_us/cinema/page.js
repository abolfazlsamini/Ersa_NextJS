...
import cinema from "../../../../public/about_us/pages/cinema.jpg";
    ...
    <main className="mt-20 overflow-hidden py-10">
      <section className="mx-auto max-w-[1200px]">
        <div className="mx-auto mt-16 flex flex-col items-center px-10 text-center sm:px-20">
          ...
          <h1 className="mb-10 mt-5 text-center">
            Involvement in the film industry and film production is one of the
            most attractive areas of investment
          </h1>
        </div>
      </section>
      ...
      <section className="mx-auto my-20 max-w-[1200px]">
        <div className="mx-auto w-11/12 px-4">
          <p>
            Involvement in the film industry and film production is one of the
            most attractive areas of investment. By producing high-quality films
            and collaborating with professional filmmakers, our company can
            generate significant profits
          </p>
          <h2 className="mb-5 mt-8">Monetization strategies</h2>
          <p>
            Production of feature films and documentaries with attractive and
            valuable content
          </p>
          <p>Cooperation with international distributors to market films</p>
          <p>
            Use of broadcasting rights and sale of films to TV channels and
            digital platforms.
          </p>
        </div>
      </section>
