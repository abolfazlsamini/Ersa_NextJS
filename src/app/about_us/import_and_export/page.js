...
import import_and_export from "../../../../public/about_us/pages/import_and_export.jpg";

import Image from "next/image";
import { useEffect, useRef } from "react";

export default function Import_and_export() {
  useEffect(() => {
    ...
    <main className="mt-20 overflow-hidden py-10">
      <section className="mx-auto max-w-[1200px]">
        <div className="mx-auto mt-16 flex flex-col items-center px-10 text-center sm:px-20">
          ...
          <h1 className="mb-10 mt-5 text-center">
            Our company builds international networks for export and import and
            supplies various goods to the target markets
          </h1>
        </div>
      </section>
      ...
      <section className="mx-auto my-20 max-w-[1200px]">
        <div className="mx-auto w-11/12 px-4">
          <p>
            Our company builds international networks for export and import and
            supplies various goods to the target markets. This activity includes
            industrial goods, agricultural products and technological items
          </p>
          <h2 className="mb-5 mt-8">Monetization strategies</h2>
          <p>
            Identification of target markets and establishment of reliable
            distribution channels
          </p>
          <p>
            Working with reputable manufacturers and suppliers to deliver
            quality goods
          </p>
          <p>
