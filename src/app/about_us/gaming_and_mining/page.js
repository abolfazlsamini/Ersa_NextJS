...
import gaming_and_mining from "../../../../public/about_us/pages/gaming_and_mining.jpg";

import Image from "next/image";
import { useEffect, useRef } from "react";

export default function Gaming_and_mining() {
  useEffect(() => {
    ...
    <main className="mt-20 overflow-hidden py-10">
      <section className="mx-auto max-w-[1200px]">
        <div className="mx-auto mt-16 flex flex-col items-center px-10 text-center sm:px-20">
          ...
          <h1 className="mb-10 mt-5 text-center">
            In the digital world, blockchain-based gaming and cryptocurrency
            mining are extremely attractive
          </h1>
        </div>
      </section>
      ...
      <section className="mx-auto my-20 max-w-[1200px]">
        <div className="mx-auto w-11/12 px-4">
          <p>
            In the digital world, blockchain-based gaming and cryptocurrency
            mining are extremely attractive. By combining these two areas, we
            have created a platform on which users can generate income through
            both gaming and mining
          </p>
          <h2 className="mb-5 mt-8">Monetization strategies</h2>
          <p>
            Development and market launch of blockchain games with integrated
            mining functions
          </p>
          <p>Sale of in-game tokens and digital items</p>
          <p>
            Creation of tournament platforms and reward systems to increase user
            engagement and generate advertising revenue
          </p>
        </div>
      </section>
