...
import forex from "../../../../public/about_us/pages/forex.jpg";
    ...
    <main className="mt-20 overflow-hidden py-10">
      ...
      <section className="mx-auto my-20 max-w-[1200px]">
        <div className="mx-auto w-11/12 px-4">
          <p>
            The forex market is one of the largest and most sought-after
            financial markets in the world. We offer brokerage services in this
            market that enable users to trade currencies
          </p>
          <h2 className="mb-5 mt-8">Monetization strategies</h2>
          <p>Generating commissions from the trades executed by users</p>
          <p>
            Providing educational and market analysis services to traders and
            charging fees
          </p>
          <p>
            Develop advanced trading platforms with analytical tools and risk
            management features
          </p>
        </div>
      </section>
