...
import tourism from "../../../../public/about_us/pages/tourism.jpg";
    ...
    <main className="mt-20 overflow-hidden py-10">
      <section className="mx-auto max-w-[1200px]">
        <div className="mx-auto mt-16 flex flex-col items-center px-10 text-center sm:px-20">
          ...
          <h1 className="mb-10 mt-5 text-center">
            The tourism industry is one of the most thriving industries in the
            world
          </h1>
        </div>
      </section>
      ...
      <section className="mx-auto my-20 max-w-[1200px]">
        <div className="mx-auto w-11/12 px-4">
          <p>
            The tourism industry is one of the most thriving industries in the
            world. By offering various tourism packages and related services, we
            present national and international tourist attractions to our
            customers
          </p>
          <h2 className="mb-5 mt-8">Monetization strategies</h2>
          <p>Development of unique and exclusive tourism packages</p>
          <p>
            Collaboration with hotels, restaurants and tourist attractions to
            offer special services
          </p>
          <p>
            Use of modern technologies to offer online services and attract more
            customers.
          </p>
        </div>
      </section>
