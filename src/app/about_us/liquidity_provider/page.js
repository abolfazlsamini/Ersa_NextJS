...
import liquidity_provider from "../../../../public/about_us/pages/liquidity_provider.jpg";

import Image from "next/image";
import { useEffect, useRef } from "react";

export default function Liquidity_provider() {
  useEffect(() => {
    ...
    <main className="mt-20 overflow-hidden py-10">
      ...
      <section className="mx-auto my-20 max-w-[1200px]">
        <div className="mx-auto w-11/12 px-4">
          <p>
            One of the core activities of our company is the provision of
            liquidity in digital markets. With the rapid growth of DeFi
            (Decentralized Finance) markets, the demand for liquidity has
            increased significantly. By providing liquidity to various exchanges
            and platforms, we create stable and sustainable profits for
            investors
          </p>
          <h2 className="mb-5 mt-8">Monetization strategies</h2>
          <p>
            Partnering with reputable exchanges to provide liquidity and earn
            trading fees
          </p>
          <p>
            Using advanced algorithms to manage liquidity and optimize profits
          </p>
          <p>
            Providing specialized liquidity services for startups and blockchain
            projects
          </p>
        </div>
      </section>
