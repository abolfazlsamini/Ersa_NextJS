...
import more from "../../../../public/about_us/pages/more.jpg";
    ...
    <main className="mt-20 overflow-hidden py-10">
      <section className="mx-auto max-w-[1200px]">
        <div className="mx-auto mt-16 flex flex-col items-center px-10 text-center sm:px-20">
          <div className="rounded-full bg-[#5566ff26] px-3 py-1 text-sm uppercase text-[#56f]">
            Conclusion and Financial plan{" "}
          </div>
          <h1 className="mb-10 mt-5 text-center">
            A detailed financial plan, including cost estimates, revenues and
            profitability of the projects, is attached to this proposal
          </h1>
        </div>
      </section>
      ...
      <section className="mx-auto my-20 max-w-[1200px]">
        <div className="mx-auto w-11/12 px-4">
          <p>
            By leveraging the existing capabilities in the nine main areas
            mentioned above, our company offers numerous opportunities for
            monetization and attracting investment. By combining these
            activities and creating synergies between them, we aim to become one
            of the pioneers in the digital and real markets. We invite you to
            invest in these projects and participate in the profitability and
            growth of this company
          </p>
          <h2 className="mb-5 mt-8">Financial plan</h2>
          <p>
            A detailed financial plan, including cost estimates, revenues and
            profitability of the projects, is attached to this proposal. Our
            goal is to raise [X million dollars] to implement these plans and
            achieve sustainable profitability within the next three years
          </p>
        </div>
      </section>
