...
import mining from "../../../../public/about_us/pages/mining.jpg";
    ...
    <main className="mt-20 overflow-hidden py-10">
      ...
      <section className="mx-auto my-20 max-w-[1200px]">
        <div className="mx-auto w-11/12 px-4">
          <p>
            The mining industry is a lucrative and important sector of the
            global economy. By exploiting rich mines, our company extracts and
            processes valuable resources
          </p>
          <h2 className="mb-5 mt-8">Monetization strategies</h2>
          <p>Investment in modern mining equipment and technologies</p>
          <p>
            Exploitation of mines for gold, silver, copper and other valuable
            minerals
          </p>
          <p>
            Direct sale of raw materials to national and international markets
          </p>
        </div>
      </section>
